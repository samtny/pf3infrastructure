...
#aws elbv2 create-listener --load-balancer-arn ${ELB_ARN} --protocol HTTPS --port 443 --default-actions Type=forward,TargetGroupArn=${TARGET_GROUP_ARN} --certificates "" --ssl-policy ""
